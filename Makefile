...
apt-simphony-deps:
	...
	apt-get update -qq
	apt-get install -y python-dev cython libhdf5 libhdf5-serial-dev libatlas-dev libatlas3gf-base
	@echo
...
ifeq ($(USE_OPENFOAM_PARAVIEW),yes)
	...
	apt-get install -y --force-yes paraview libhdf5 libhdf5-openmpi-dev
	@echo
